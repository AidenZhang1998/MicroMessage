			...
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">内容列表
					 <a class="btn03"  href="${basePath}InitTalkServlet.action">功能预览</a>&nbsp;&nbsp;&nbsp;&nbsp;
					 <a class="btn03"  href="${basePath}CreateOneServlet.action">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;
					 <a class="btn03" href="javascript:DeleteBatch('<%= basePath%>');">批量删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
				...
				<c:forEach items="${messageList}" var="message" varStatus="status">
									<tr  
										...
										<td>
											<a href="${basePath}EditMessage.action?id=${message.id}">修改</a>&nbsp;&nbsp;&nbsp;
